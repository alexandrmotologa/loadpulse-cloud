# Contributing to LoadPulse Cloud

Thank you for your interest in contributing to LoadPulse Cloud! We welcome contributions of all kinds, whether you are fixing a bug, improving documentation, or proposing new features.
...
1. **Fork the repository** and clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/loadpulse-cloud.git
   cd loadpulse-cloud
   ```
...
LoadPulse Cloud requires **Node.js 20+ LTS** and npm.
